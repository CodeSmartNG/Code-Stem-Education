                    ...
                    {editingCourse === key ? (
                      ...
                      <>
                        ...
                        <div className="course-actions">
                          <button className="edit-btn" onClick={() => startEditCourse(key)}>✏️ Edit</button>
                          <button className="view-btn" onClick={() => startViewLessons(key)}>📚 Manage Lessons</button>
                          <button className="delete-btn" onClick={() => handleDeleteCourse(key)}>🗑️ Delete</button>
                        </div>
                      </>
                    )}
                  </div>
            ...
            {!viewingCourseLessons ? (
              ...
              <div className="lessons-management">
                ...
                <div className="lessons-list">
                  {courses[viewingCourseLessons]?.lessons?.length === 0 ? (
          ...
          <div className="add-course-tab">
            ...
            <form onSubmit={handleAddCourse} className="teacher-form">
              ...
              <div className="form-group">
                ...
                />
                <small>Used for URL and identification</small>
              </div>
